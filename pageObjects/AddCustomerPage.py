...
class AddCustomer:
    ...
    SubMenu_Customers_xpath = "//a[@href='/Admin/Customer/List']"
    Customers_AddNew_xpath = "//a[@href='/Admin/Customer/Create']"
    CustomerInfo_Email_xpath = "//input[@id='Email']"
    CustomerInfo_Password_xpath = "//input[@id='Password']"
    CustomerInfo_FirstName_xpath = "//input[@id='FirstName']"
    CustomerInfo_LastName_xpath = "//input[@id='LastName']"
    CustomerInfo_GenderMale_xpath = "//input[@id='Gender_Male']"
    CustomerInfo_GenderFemale_xpath = "//input[@id='Gender_Female']"
    CustomerInfo_DateOfBirth_xpath = "//input[@id='DateOfBirth']"
    CustomerInfo_CompanyName_xpath = "//input[@id='Company']"
    CustomerInfo_TaxExempt_xpath = "//input[@id='IsTaxExempt']"
    CustomerInfo_Newsletter_xpath = "//ul[@id='SelectedNewsletterSubscriptionStoreIds_taglist']"
    CustomerInfo_CustomerRoles_xpath = "//input[@aria-describedby='SelectedCustomerRoleIds_taglist']"
    CustomerInfo_CustomerRoles_Administrators_xpath = "//li[contains(text(), 'Administrators')]"
    CustomerInfo_CustomerRoles_ForumModerators_xpath = "//li[contains(text(), 'Forum Moderators')]"
    CustomerInfo_CustomerRoles_Guests_xpath = "//li[contains(text(), 'Guests')]"
    CustomerInfo_CustomerRoles_Registered_xpath = "//li[contains(text(), 'Registered')]"
    CustomerInfo_CustomerRoles_Vendors_xpath = "//select[@id='VendorId']"
    CustomerInfo_AdminComment_xpath = "//textarea[@id='AdminComment']"
    CustomerInfo_Save_xpath = "//button[@name='save']"
